...
class Day02 extends Base {
  ...
  private static class Program {
    ...
    Program(final List<Integer> opcodes) {
      this.opcodes = newArrayList(opcodes);
      memory = newArrayList(opcodes);
    }
    ...
    Integer execute(final Integer noun, final Integer verb) {
      memory = newArrayList(opcodes);
      memory.set(1, noun);
      memory.set(2, verb);
      return run();
  ...
  Day02(final List<String> inputLines) {
    super(inputLines);
  }

  public static void main(String args[]) {
    out.println(new Day02(inputForDay(2)).part1()); // 3654868
    out.println(new Day02(inputForDay(2)).part2()); // 7014
  }
